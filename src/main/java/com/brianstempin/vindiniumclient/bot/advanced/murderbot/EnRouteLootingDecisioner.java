...
public class EnRouteLootingDecisioner implements Decision<AdvancedMurderBot.GameContext, BotMove> {
    ...
    public EnRouteLootingDecisioner(Decision<AdvancedMurderBot.GameContext, BotMove> noGoodMineDecisioner,Decision<AdvancedMurderBot.GameContext, BotMove> healDecisioner) {
